...
```
$ git clone https://github.com/benadaba/nginx-ingress
...
```
$ openssl req -x509 -nodes -days 365 -newkey rsa:2048 -out datapandas-ingress-tls.crt -keyout datapandas-ingress-tls.key -subj "/CN=javawebapp.datapandasconsulting.com/O=datapandas-ingress-tls"
...
kind: Ingress
metadata:
  name: datapandasappingressrule
  namespace: test-ns
spec:
  ingressClassName: nginx
  tls:
  - hosts:
      - datapandasconsulting.com
